...
data class Component(val info: ComponentInfo, val config: ComponentConfig) {
    companion object ComponentSerializer : KSerializer<Component> {
        ...
        override fun deserialize(decoder: Decoder): Component {
            ...
            val config =
                decoder.json.decodeFromJsonElement(ComponentConfig.serializer(), jsonObject)

            return Component(info = info, config = config)
        }
