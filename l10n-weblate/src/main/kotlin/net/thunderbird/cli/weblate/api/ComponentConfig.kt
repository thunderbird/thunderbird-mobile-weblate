 ...
 *
 * This maps the shape of `golden-component-config.json` used by the CLI. Defaults are provided so
 * decoding remains tolerant when the server omits optional keys.
 *
...
data class ComponentConfig(
    ...
    val priority: Int = 0,
    @SerialName("is_glossary") val isGlossary: Boolean = false,
    @SerialName("glossary_color") val glossaryColor: String = "",
    @SerialName("enable_suggestions") val enableSuggestions: Boolean = false,
    @SerialName("suggestion_voting") val suggestionVoting: Boolean = false,
    @SerialName("suggestion_autoaccept") val suggestionAutoaccept: Int = 0,
    @SerialName("allow_translation_propagation") val allowTranslationPropagation: Boolean = false,
    @SerialName("check_flags") val checkFlags: String = "",
    @SerialName("variant_regex") val variantRegex: String = "",
    @SerialName("enforced_checks") val enforcedChecks: List<String> = emptyList(),
    @SerialName("secondary_language") val secondaryLanguage: String? = null,
    val repoweb: String = "",
    @SerialName("push_on_commit") val pushOnCommit: Boolean = false,
    @SerialName("commit_pending_age") val commitPendingAge: Int = 0,
    @SerialName("auto_lock_error") val autoLockError: Boolean = false,
    @SerialName("commit_message") val commitMessage: String = "",
    @SerialName("add_message") val addMessage: String = "",
    @SerialName("delete_message") val deleteMessage: String = "",
    @SerialName("merge_message") val mergeMessage: String = "",
    @SerialName("addon_message") val addonMessage: String = "",
    @SerialName("pull_message") val pullMessage: String = "",
    @SerialName("language_regex") val languageRegex: String = "",
    @SerialName("key_filter") val keyFilter: String = "",
    @SerialName("file_format_params") val fileFormatParams: FileFormatParams = FileFormatParams(),
    @SerialName("edit_template") val editTemplate: Boolean = false,
    val intermediate: String = "",
    @SerialName("new_lang") val newLang: String = "",
    @SerialName("language_code_style") val languageCodeStyle: String = "",
    @SerialName("screenshot_filemask") val screenshotFilemask: String = "",
)

@Serializable
data class FileFormatParams(@SerialName("xml_closing_tags") val xmlClosingTags: Boolean = false)
