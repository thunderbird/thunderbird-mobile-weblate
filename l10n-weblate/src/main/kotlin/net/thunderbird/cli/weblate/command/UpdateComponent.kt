...
class UpdateComponent : BaseCommand(name = "update") {
    override fun help(context: Context): String = "Update locally discovered components"
    ...
    override fun onRun(
        ...
        println("Loaded ${allComponents.size} components (${managed.size} discovered locally, ${skipped.size} skipped):")
        ...
        if (skipped.isNotEmpty()) {
            println("-------")
            println()
            println("Skipped components (not discovered locally):")
            println()
